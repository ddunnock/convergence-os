 ...
 *
 * @description Combines clsx for conditional class names with tailwind-merge
 * to intelligently merge Tailwind classes, resolving conflicts and removing duplicates.
 *
